...
export const products: Product[] = [
  {
    ...
    price: 2500,
    edition: "Edition of Twelve",
    size: "A5 (14.8 × 21 cm)",
    paper: "Thick, deep-texture paper, cream bronze flaked",
